...
var app = new Vue({
    ...
    watch: {},
    methods: {
        showInvInfo: function showInvInfo() {
            if (this.goodsInvoiceList.length && this.goodsInvoiceList[0].invoice) {
                this.batchInfo = {
                    inCompany: this.goodsInvoiceList[0].invoice.inCompany,
                    billPaperType: this.goodsInvoiceList[0].invoice.billPaperType,
                    taxRate: this.goodsInvoiceList[0].invoice.taxRate,
                    billCreateDate: this.goodsInvoiceList[0].invoice.billCreateDate.split(' ')[0],
                    billCode: this.goodsInvoiceList[0].invoice.billCode,
                    billMoney: this.goodsInvoiceList[0].invoice.billMoney,
                    openBank: this.goodsInvoiceList[0].invoice.openBank,
                    openAccount: this.goodsInvoiceList[0].invoice.openAccount,
                    taxpayerCode: this.goodsInvoiceList[0].invoice.taxpayerCode,
                    lpAddress: this.goodsInvoiceList[0].invoice.lpAddress,
                    phone: this.goodsInvoiceList[0].invoice.phone
                };
            } else {
                this.batchInfo = {
                    inCompany: '',
        ...
        allMoneyFun: function allMoneyFun() {
            ...
            this.allMoney = money.toFixed(2) + '元';
        },
        ...
        addGoods: function addGoods() {
            window.location.href = 'income-ticket-waitenter.html?from=batch';
        ...
        selectInvoice: function selectInvoice(item) {
            this.batchInfo = {
        ...
        submit: function submit(type) {
            ...
            data.customerUid = this.goodsList[0].customerId;
            ...
            if (flag) {
                ...
                if (flag1) {
                    ...
                    $http('/incomebill/saveIncombills', data).then(function (res) {
