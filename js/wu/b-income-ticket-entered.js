...
var app = new Vue({
    ...
    created: function created() {
        ...
        if (sessionStorage.getItem("IncomeBill_detailList")) {
            this.searchList.inCompany = JSON.parse(sessionStorage.getItem("IncomeBill_detailList"))[0].supply;
        }
    ...
    mounted: function mounted() {
        ...
        //     enterSupMoneny += (+val.height2 - +val.height3) * +val.single
        // })
    ...
    methods: {
        ...
        toBatchEnter: function toBatchEnter() {
            if (this.checkedItem.length) {
                ...
                window.location.href = 'b-income-ticket-batchenter.html?memberId=' + this.gGetQueryString('memberId');
            }
        },
                ...
                if (res.data.resultCode == 200) {
                    if (res.data.resultData) {
                        ...
                        _this3.invoiceList.map(function (val) {
                            ...
                            _this3.searchList.memberId = _this3.invoiceList[0].memberId;
                        });
        ...
        editClick: function editClick(item) {
            ...
            $http('/incomebill/findTicketByCode', {
                billCode: this.editBillCode,
        ...
        //删除发票接口
        delInvoice: function delInvoice(item) {
            var _this6 = this;

            $http('/incomebill/deleteTicketByCode', {
                billCode: this.editBillCode,
                memberId: this.gGetQueryString("memberId")
            }).then(function (res) {
                if (res.data.resultCode == 200) {
                    _this6.$message({
                        message: '操作成功！',
