...
var app = new Vue({
    ...
    methods: {
        ...
        toSearch: function toSearch(v) {
            ...
            if (v == 2) {
                this.goShop(Object.assign(this.searchList, params));
            }
        ...
        goShop: function goShop() {
            ...
            this.loading = true;
            this.tabBtn = 2;
            $http('/queryBill/queryBillByParas', params).then(function (res) {
                if (res.data.resultCode == 200) {
        ...
        toDetail: function toDetail(id, ticketType) {
            ...
            if (ticketType == '销项票') {
                window.location.href = 'y_sales_review_details.html?id=' + id;
            }
        },
        ...
        exportExcell: function exportExcell(v) {
            ...
            if (v == 1) {
                ...
                console.log(exportData);
                window.location.href = 'http://47.100.247.219:9090/queryBill/queryBillBygoodsExcel?' + Qs.stringify(exportData);
            }
        }
    }
